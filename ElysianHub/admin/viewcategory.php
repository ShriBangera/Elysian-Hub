...
<table id="mydataTable"  class="table table-striped table-bordered">
							...
							{$c++;
								...
								<td>$c</td>
									...
									<td><img src='../imgcategory/$rs[categoryimg]' style='width:95px;height:75px;object-fit: contain;'</td>
									<td>$rs[description]</td>
									<td>$rs[status]</td>";
									if ($_SESSION['emptype']=='Admin' || $_SESSION['emptype']=='Employee') {
									echo "<td><center><b><a href='category.php?editid=$rs[0]' class='btn btn-info'>Edit</a><hr> <a href='viewcategory.php?delid=$rs[0]' onclick='return confirmdelete()'class='btn btn-danger'>Delete</a></center></b></td>";
                                       }
									echo "</tr>";
							}
							?>
